...
$pdk.plugin.doubleclick = $pdk.extend(function(){},
{
	...
	onProxyPause: function(e){
		...
		this._controller.dispatchEvent("OnMediaPause", this._currentClip);
...
var doubleclickPlugIn = new $pdk.plugin.doubleclick();
tpController.plugInLoaded(doubleclickPlugIn, null); //doubleclickPlugIn.overlays);
