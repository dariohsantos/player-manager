SampleVideoProxyPlugIn = Class.extend({
	...
	init: function() {
		...
		{
			this.adUrl = "http://ne.edgecastcdn.net/0008B0/mps/PDK/467/142/Midh264_720p11sec.mp4";
		}
		else if (v.canPlayType('video/ogg'))
		{
			this.adUrl = "http://ne.edgecastcdn.net/0008B0/mps/PDK/59/933/Ad_VidoProxyPlugIn.ogg";
		}
	},
	...
	onProxyPause: function(e){
		...
		this.paused = true;
		clearInterval(this.playbackInterval);
		this.controller.dispatchEvent("OnMediaPause", this.currentClip);
