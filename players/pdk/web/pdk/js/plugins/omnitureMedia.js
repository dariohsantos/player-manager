...
$pdk.plugin.OmniturePlugin = $pdk.extend(function() {}, {
	...
	loadComplete: function() {
		...
		tpController.addEventListener("OnMediaPlaying", function(e) {
			me.onMediaPlaying(e)
		});

		tpController.addEventListener("OnMediaBuffer", function(e) {
			me.onMediaPause(e)
		});

		tpController.addEventListener("OnMediaPlay", function(e) {
			me.onMediaUnpause(e)
		});
