package com.theplatform.pdk.mediators
{
	...
	public class PostCloseMediator extends FormButtonControlMediator
	{
		...
		public function PostCloseMediator(id:String, controller:IViewController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		{
			card.call(PostFormFunctions.closePost, []);//should be registered in the email card mediator
		}
