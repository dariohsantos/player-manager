package com.theplatform.pdk.mediators
{
	...
	public class DefaultPostMediator extends PlayerButtonControlMediator
	{

		private static const DEFAULT_TOOLTIP:String = "Get Post";
		private static const DEFAULT_LABEL:String   = "POST";
		private static const DEFAULT_ICON:String    = IconType.POST;
		
		public function DefaultPostMediator(id:String, controller:IPlayerController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		override protected function setItem(item:Item):void
		{
			...
			if (!_buttonControl) throw new IllegalOperationError("the type of control set on the DefaultPostMediator was incorrect");
		...
		{
			_pController.closeFullScreenThenShowCard("forms", "tpPostCard", CardActions.DISABLE);
		}
