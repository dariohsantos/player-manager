package com.theplatform.pdk.mediators
{
	...
	public class LinkCopyToClipboardMediator extends FormButtonControlMediator
	{
		private static const DEFAULT_TOOLTIP:String = "Copy Link text to clipboard";
		private static const DEFAULT_LABEL:String   = "Copy to clipboard";
		private static const DEFAULT_ICON:String    = IconType.NONE;
		
		public function LinkCopyToClipboardMediator(id:String, controller:IViewController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		{
			card.call(LinkFormFunctions.copyToClipboard, []);
		}
