package com.theplatform.pdk.mediators
{
	...
	public class SingleShareTitleMediator extends Mediator
	{
		private var _txtControl:TextControl;
		
		public function SingleShareTitleMediator(id:String, controller:IViewController, metadata:ItemMetaData=null)
		{
		...
		{
			//register functions
			card.registerFunction("setSharingSiteTitle", this, setText);
		}
