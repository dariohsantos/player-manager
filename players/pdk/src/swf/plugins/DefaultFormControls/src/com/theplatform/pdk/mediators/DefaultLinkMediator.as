package com.theplatform.pdk.mediators
{
	...
	public class DefaultLinkMediator extends PlayerButtonControlMediator
	{

		private static const DEFAULT_TOOLTIP:String = "Get Link";
		private static const DEFAULT_LABEL:String   = "Link";
		private static const DEFAULT_ICON:String    = IconType.LINK;
		
		protected var _isShowingLinkForm:Boolean;		
		
		public function DefaultLinkMediator(id:String, controller:IPlayerController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		override protected function setItem(item:Item):void
		{
			...
			if (!_buttonControl) throw new IllegalOperationError("the type of control set on the DefaultLinkMediator was incorrect");
		...
		{
			_pController.closeFullScreenThenShowLinkForm(!_isShowingLinkForm);
		}
		
		protected function handleShowLinkForm(e:PdkEvent):void
		{
			_isShowingLinkForm = Boolean(e.data);
		}
		...
		override public function destroy():void
		{
			...
			_controller.removeEventListener(PdkEvent.OnShowLinkForm, handleShowLinkForm);
