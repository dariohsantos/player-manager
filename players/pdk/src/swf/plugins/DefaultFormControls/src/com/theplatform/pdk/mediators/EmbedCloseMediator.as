package com.theplatform.pdk.mediators
{
	...
	public class EmbedCloseMediator extends FormButtonControlMediator
	{
		...
		public function EmbedCloseMediator(id:String, controller:IViewController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		{
			card.call(EmbedFormFunctions.closeEmbed, []);//should be registered in the email card mediator
		}
