package com.theplatform.pdk.mediators
{
	...
	public class InfoCloseMediator extends FormButtonControlMediator
	{
		...
		public function InfoCloseMediator(id:String, controller:IViewController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		{
			card.call(InfoFormFunctions.closeInfo, []);//should be registered in the email card mediator
		}
