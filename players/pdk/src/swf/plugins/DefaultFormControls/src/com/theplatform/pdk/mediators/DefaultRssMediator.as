package com.theplatform.pdk.mediators
{
	...
	public class DefaultRssMediator extends PlayerButtonControlMediator
	{

		private static const DEFAULT_TOOLTIP:String = "Get RSS";
		private static const DEFAULT_LABEL:String   = "RSS";
		private static const DEFAULT_ICON:String    = IconType.RSS;
		
		public function DefaultRssMediator(id:String, controller:IPlayerController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		override protected function setItem(item:Item):void
		{
			...
			if (!_buttonControl) throw new IllegalOperationError("the type of control set on the DefaultRssMediator was incorrect");
		...
		{
			_pController.closeFullScreenThenShowCard("forms", "tpRssCard", CardActions.DISABLE);
		}
