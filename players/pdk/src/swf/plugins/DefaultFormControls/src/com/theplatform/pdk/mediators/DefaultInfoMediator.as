package com.theplatform.pdk.mediators
{
	...
	public class DefaultInfoMediator extends PlayerButtonControlMediator
	{

		private static const DEFAULT_TOOLTIP:String = "Get Info";
		private static const DEFAULT_LABEL:String   = "INFO";
		private static const DEFAULT_ICON:String    = IconType.INFO;
		
		public function DefaultInfoMediator(id:String, controller:IPlayerController, metadata:ItemMetaData=null, resources:Object=null)
		{
		...
		protected function handleClick(e:ButtonEvent):void
		{
			...
			{
				_pController.closeFullScreenThenShowCard("forms", "tpInfoCard", CardActions.DISABLE);
			}else
			{
				_pController.closeFullScreenThenShowCard("forms", "tpInfoCard", CardActions.DISABLE, null, null, card.initVars);
			}
		}
