...
$config['akamai_purge_user'] = 'joaco@latinstockdigital.com';
$config['akamai_purge_password'] = 'Pa$$W0rD5';
$config['akamai_purge_endpoint'] = 'https://api.ccu.akamai.com/ccu/v2/queues/default';
